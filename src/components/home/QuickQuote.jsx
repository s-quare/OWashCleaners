    ...
    <section className="py-10 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="relative bg-brand-gold/90 p-8">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-3 bg-white text-brand-gold px-10 py-4 rounded-full font-bold text-lg shadow-lg hover:bg-slate-50 transition-transform hover:scale-105"
            >
